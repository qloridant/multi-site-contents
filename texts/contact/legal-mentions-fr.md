...
pour mener des enquêtes de satisfaction facultatives sur https://multi.coop : adresse email
...
droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui https://multi.coop devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement désigné
